...
class TeachArguments:
    ...
    train_path: str = field(default='../datasets/HDFS/train.csv', metadata={"help": "Path to training data"})
    save_teacher_path: str = field(default='../datasets/HDFS/model/teacher.pth', metadata={"help": "Path to save the teacher model"})
    save_student_path: str = field(default='../datasets/HDFS/model/student.pth', metadata={"help": "Path to save the student model"})
...
class TrainArguments:
    ...
    train_path: str = field(default='./datasets/HDFS/train.csv', metadata={"help": "Path to training data"})
    save_teacher_path: str = field(default='./datasets/HDFS/model/teacher.pth', metadata={"help": "Path to save the teacher model"})
    save_noKD_path: str = field(default='./datasets/HDFS/model/noKD.pth', metadata={"help": "Path to save the no KD model"})
...
class TestArguments:
    ...
    save_teacher_path: str = field(default='../datasets/HDFS/model/teacher.pth', metadata={"help": "Path to saved teacher model"})
    save_student_path: str = field(default='../datasets/HDFS/model/student.pth', metadata={"help": "Path to saved student model"})
    save_noKD_path: str = field(default='../datasets/HDFS/model/noKD.pth', metadata={"help": "Path to saved noKD model"})
    test_path: str = field(default='../datasets/HDFS/test.csv', metadata={"help": "Path to test data"})
    save_quantized_path: str = field(default='../datasets/HDFS/model/quantized_model.pth', metadata={"help": "Path to save quantized model"})
    pca_vector: str = field(default='../datasets/HDFS/pca_vector.csv', metadata={"help": "Path to PCA vector data"})
